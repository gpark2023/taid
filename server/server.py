...
class User:
	def __init__(self):
		self.admin = []
		self.donors = [{'name': 'gooha', 'id': 'gooha', 'pw': 'gooha', 'wallet': '5c354ad8f4484fb3a39273b1587b1080', 'anonymity': '0'}]
		self.recis = [{'name': "Saint Paul's Anna's House", 'id': 'Anna', 'pw': 'Anna', 'wallet': '5f979dfb57624830a91dd6dda787d12f', 'residence': 'Korea, Gyeongsangbuk-do', 'age': 'Retired Nuns', 'story': "This is a community consisted of around 50 retired nuns. We are entriely operated by donations, and we do not receive any government support. Please help us purchase basic neccessities such as rice. If this donation is fully met, this will provide a full 1 month food ration for the nuns.       http://www.anna.or.kr/"},{'name': 'Mother Gemma', 'id': 'Gemma', 'pw': 'Gemma', 'wallet': 'c274f599a24f41d797a60d63f356e26b', 'residence': 'Korea, Gyeongsangbuk-do', 'age': '70', 'story': "This is a community consisted of around 50 retired nuns. We are entriely operated by donations, and we do not receive any government support. Please help us purchase basic neccessities such as toilet paper. If this donation is fully met, this will provide a full 1 month ration for the nuns.       http://www.anna.or.kr/\n"}] # recis 37, won,add website, 8, man wan
        self.shops = [{'name': 'Amazon', 'id': 'amazon', 'pw': 'amazon', 'wallet':
		self.shops = [{'name': 'Amazon', 'id': 'amazon', 'pw': 'amazon', 'wallet': 'e4408ab6fdd1443ca5b099afd32588d1', 'region': 'use', 'goods': {'Bike': '15', 'Water': '5', 'Bread': '7'}}]
